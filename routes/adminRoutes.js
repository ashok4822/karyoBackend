...
import { listCategories, addCategory, editCategory, deleteCategory, restoreCategory } from "../controllers/categoryController.js";
import multer from 'multer';
import { addProduct, listProducts, getProductById, editProduct, deleteProduct, deleteVariant, updateVariant, getVariantOptions, getBrandOptions, addVariant } from '../controllers/productController.js';
...
router.post('/products', verifyAdmin, uploadProduct, handleMulterError, addProduct);
...
router.put('/products/:id', verifyAdmin, uploadProduct, handleMulterError, editProduct);
router.delete('/products/:id', verifyAdmin, deleteProduct);
router.post('/products/:productId/variants', verifyAdmin, uploadProduct, handleMulterError, addVariant);
router.delete('/products/:productId/variants/:variantId', verifyAdmin, deleteVariant);
router.put('/products/:productId/variants/:variantId', verifyAdmin, updateVariant);
